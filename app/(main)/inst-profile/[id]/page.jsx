                ...
                <div className="col-span-12 lg:col-span-4 ">
                    <div className="bg-white rounded-2xl p-6 shadow">
                        ...
                        <p className="text-gray-600 text-xs leading-[1.8] text-justify">
                            Hi! I'm Maxim Castornyi. I'm a web developer with a serious love for teaching I am a founder of easy Learning and a passionate Web Developer, Programmer & Instructor.
                            <br />
